...
<INCLUDE_TYPOSCRIPT: source="DIR:EXT:site_default/Configuration/TypoScript/Configuration" extensions="ts">
...
# Includes Components
<INCLUDE_TYPOSCRIPT: source="DIR:EXT:site_default/Configuration/TypoScript/Components" extensions="ts">
