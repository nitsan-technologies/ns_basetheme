...
class GridToContainerWizard implements UpgradeWizardInterface, RepeatableInterface
{
    ...
    public function executeUpdate(): bool
    {
        ...
        while ($record = $statement->fetch()) {
            ...
            if($installedTheme[0] == 'ns_theme_company2'){
                $containerCtype = ['ns_base_container','ns_base_1Cols','ns_base_2Cols', 'ns_base_3Cols'];
                $gridsCtype = ['nsBase1Col','nsCompany1Col','nsBase2Col', 'nsBase3Col'];
            }
